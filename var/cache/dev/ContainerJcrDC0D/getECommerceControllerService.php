 ...
 */
class getECommerceControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\ECommerceController' shared autowired service.
     *
     * @return \App\Controller\ECommerceController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ECommerceController.php';

        $container->services['App\\Controller\\ECommerceController'] = $instance = new \App\Controller\ECommerceController();
        ...
        ]))->withContext('App\\Controller\\ECommerceController', $container));
